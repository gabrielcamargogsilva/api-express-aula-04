...
- Persistir os dados em SQLite, PostgreSQL ou MongoDB.
- Separar rotas, controladores e regras de validação em arquivos próprios.
- Adicionar autenticação para rotas de escrita.
